The C code allows you to record button presses for 10 seconds and then loop it. The python code lets you read the output and print it to a CSV which you can edit.
